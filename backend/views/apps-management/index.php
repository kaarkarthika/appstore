...
/* @var $searchModel backend\models\AppsManagementSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Apps Managements';
$this->params['breadcrumbs'][] = $this->title;

$session = Yii::$app->session;
$session['user_logintype']; 
?>
<div class="apps-management-index">
 <div class="box box-primary  ">
      <div class=" ">
   
        <div class=" box-header with-border box-header-bg">
   <h3 class="box-title pull-left" ><?= Html::encode($this->title) ?></h3><br><br>
   <?php if($session['user_logintype']=='T1'){?>
   <?= Html::a('Add Apps', ['create'], ['class' => 'btn btn-success']) ?>
<?php }?>    
</div>
    </div>
